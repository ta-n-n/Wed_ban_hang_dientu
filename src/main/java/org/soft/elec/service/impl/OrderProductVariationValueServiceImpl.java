...
public class OrderProductVariationValueServiceImpl implements OrderProductVariationValueService {
    ...
    @Autowired
    private OrderProductVariationValueRepository orderProductVariationValueRepository;

    @Autowired
    private OrderProductVariationValueMapper orderProductVariationValueMapper;
    ...
    @Override
    @Transactional
    public OrderProductVariationValueResponse createOrderProductVariationValue(OrderProductVariationValueRequest request) {
        OrderProductVariationValue orderProductVariationValue = orderProductVariationValueMapper.toEntity(request);
        OrderProductVariationValue saved = orderProductVariationValueRepository.save(orderProductVariationValue);
        return orderProductVariationValueMapper.toResponse(saved);
    }

    @Override
    @Transactional
    public OrderProductVariationValueResponse updateOrderProductVariationValue(Integer id, OrderProductVariationValueRequest request) {
        OrderProductVariationValue orderProductVariationValue = orderProductVariationValueRepository.findById(id)
        ...
        OrderProductVariationValue updated = orderProductVariationValueRepository.save(orderProductVariationValue);
    ...
    public List<OrderProductVariationValueResponse> getAllOrderProductVariationValues() {
        return orderProductVariationValueRepository.findAll()
                .stream()
